                    ...
                    <table className='FacultyFormTable'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className='text-field__input' id='id' type="text" name='id' placeholder='Код' required />
                                </td>
                            </tr>
                            <tr>
                                <td className='td_label'>
                                ...
                                <td>
                                    <input className='text-field__input' type="text" name='faculty' id='faculty' placeholder='Название' required />
                                </td>
                            </tr>
                            <tr>
                                <td></td><td>
