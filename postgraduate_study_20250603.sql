...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 03 2025 г., 18:07
...
('Filatova_Yaroslava_Pavlovna_stud', '7d6674cc5474f9e3184f9970224504ea6753972bd4d18c1ac6f33a8ce69a47c4', 137),
...
('Mel`nikova_Elizaveta_Bogdanovna_agent', '5ca7da9a8e2f39e9dcbec8c08af7851b22ecfc14664df21bc4f8a55bb46bf8c7', 135),
...
('Sviridova_Mariya_Matveevna_stud', '8ec4cde70afe8701f544f56729f012ae5df51f197435acd4396736cdb0d4e07e', 136),
...
(28, 'Основы подготовки и оформления диссертаций, монографий, статей', NULL, ''),
(29, 'Математическое моделирование химических реакций', NULL, ''),
(30, 'История и философия науки', NULL, 'тест');
...
CREATE TABLE `graduatestudents` (
  `userID` int(11) NOT NULL,
  `scientificSupervisorID` int(11) DEFAULT NULL,
  `department` int(11) DEFAULT NULL,
...
('2S3Zni_7B1bWj7olmZfGhYFt12CGQ9AL', 1748882440, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"this_user\":22}'),
('BxDSg4W6po_sgUAm16ys6BOQeYnTHD-A', 1749052033, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"this_user\":135}'),
('qV3BPGezk3Ezwug7UXrHnhck4c6alX25', 1748958104, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"this_user\":null}');
...
(135, 'Елизавета', 'Богдановна', 'Мельникова', 3, 0),
(136, 'Мария', 'Матвеевна', 'Свиридова', 1, 0),
(137, 'Ярослава', 'Павловна', 'Филатова', 1, 0);
