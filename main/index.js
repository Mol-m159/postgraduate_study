...
app.post('/:index/RegistrationFile', function (req, res) { fromFile.registration1(req, res, app, pool) })
app.post('/:index/RegistrationFile2/:role', function (req, res) { fromFile.registration2(req, res, app, pool) })
app.post('/:index/newspecialties', async function (req, res) { fromFile.newspecialties(req, res, pool) });
