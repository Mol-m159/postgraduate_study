    ...
    function equals(elem, base) {
     ...
     const onShow = (e) => {
            alert('Файл должен содержать колонки с названиями:\n"Название",\n	"Преподаватель",\n "Комментарий",\n "Аспирант",\n "Оценка",\n "Дата" \n' +
                 ...
                 'Название, Преподаватель, Комментарий могут содержать значение только на 2 строке. \n Преподаватель, Комментарий могут быть пустыми.\n'+
                'Преподаватель и Аспиранты: "Фамилия И. О."\n Оценка: число от 0 до 5, где 0 - неявка. \n'+
                'Дата в формате: ГГГГ-ММ-ДД текстом.')
        }
    return (
        <>
                ...
                {!data[0] ?'':<><table className='RegistrationFormTAble'>
                    <tbody>               
                        <tr>
                            ...
                            <td colSpan={3}>
                                <input className='text-field__input' type="text"
                                    defaultValue={data[0].Название} maxlength="100" name='name' placeholder='Название' required />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colSpan={3}>
                                <input maxlength="100" className='text-field__input' defaultValue={data[0].Комментарий} type="text" name='note' placeholder='Комментарий' />
                            </td>
                        </tr>
                        {data.map((row, index) => (
                            rowProc(index, row)
