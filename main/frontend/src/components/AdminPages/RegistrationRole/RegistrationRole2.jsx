...
export default function RegistrationRole2(){
    ...
    return (<>
        <form className='AdminBobyForm' method="post" action={(`http://localhost:3001/${userID}/RegistrationForm/2`)}>
            <table className='RegistrationFormTAble'>
                ...
                <tbody className='formRole' id='formRole2'>
                    {!faculties ? (<><tr>
