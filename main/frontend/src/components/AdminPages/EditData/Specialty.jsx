                    ...
                    <table className='FacultyFormTable'>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input maxlength="100" className='text-field__input' id='specialty' type="text" name='specialty' placeholder='Специальность' required />
                                </td>
                            </tr>
                            <tr>
                                <td></td><td>
                    ...
                    <table className='FacultyFormTable'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input maxlength="100" className='text-field__input' id='specialty' type="text" name='specialty' placeholder='Название' required />
                                </td>
                            </tr>
                            <tr>
                                <td></td><td>
