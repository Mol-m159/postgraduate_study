                    ...
                    <table className='FacultyFormTable'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input  maxlength="100" className='text-field__input' type="text" name='department' placeholder='Название' required />
                                </td>
                            </tr>
                            <tr>
                                <td></td><td>
                    ...
                    <table className='FacultyFormTable'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input  maxlength="100" className='text-field__input' type="text" name='department' id='department' placeholder='Название' required />
                                </td>
                            </tr>
                            {!faculties ? (<><tr>
                                <td>Загрузка данных</td>
