            ...
            <table className='RegistrationFormTAble'>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input  maxlength="100" className='text-field__input' type="text" id='name' name='name' placeholder='Название' required />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input maxlength="100" className='text-field__input' type="text" id='note' name='note' placeholder='Комментарий' />
                        </td>
                    </tr>
                    <tr>
                        <td></td><td>
