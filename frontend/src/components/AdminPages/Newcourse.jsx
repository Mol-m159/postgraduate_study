                    ...
                    <table className='RegistrationFormTAble'>
                        <tbody>
                            <tr>
                                ...
                                <td colSpan={3}>
                                    <input className='text-field__input' type="text" name='name' placeholder='Название' required />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colSpan={3}>
                                    <input className='text-field__input' type="text" name='note' placeholder='Комментарий' />
                                </td>
                            </tr>
